...
while True:
    ...
    resolution = f"Resolution: {im.shape[1]}x{im.shape[0]}"
    text1 = f"FPS: {fps:.2f} | CPU Usage: {cpu_usage:.2f}%"
    text2 = f"Memory Usage: {mem_usage:.2f}%"

    # 텍스트를 이미지에 표시
    cv2.putText(im, text1, (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
    cv2.putText(im, text2, (10, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
    cv2.putText(im, resolution, (10, 150), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
